...
public interface FunctionFunctions {
  ...
  static <T1, T2, T3, R, E extends Exception> R applyAndWrap(
      T1 value1, T2 value2, T3 value3, ThrowingFunction3<T1, T2, T3, R, E> function
  ) {
    try {
  ...
  static <T1, T2, T3, T4, R, E extends Exception> R applyAndWrap(
      T1 value1, T2 value2, T3 value3, T4 value4, ThrowingFunction4<T1, T2, T3, T4, R, E> function
  ) {
    try {
